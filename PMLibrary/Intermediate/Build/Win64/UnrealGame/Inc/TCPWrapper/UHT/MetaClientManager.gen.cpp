...
#include "TCPWrapper/Public/MetaClientManager.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMetaClientManager() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UActorComponent();
	TCPWRAPPER_API UClass* Z_Construct_UClass_UMetaClientManager();
	TCPWRAPPER_API UClass* Z_Construct_UClass_UMetaClientManager_NoRegister();
	...
	TCPWRAPPER_API UScriptStruct* Z_Construct_UScriptStruct_FLiDARFrameData();
	TCPWRAPPER_API UScriptStruct* Z_Construct_UScriptStruct_FLiDARMapperMessage();
	TCPWRAPPER_API UScriptStruct* Z_Construct_UScriptStruct_FLiDARPosition();
	TCPWRAPPER_API UScriptStruct* Z_Construct_UScriptStruct_FMetaBinaryMessage();
	TCPWRAPPER_API UScriptStruct* Z_Construct_UScriptStruct_FMetaMessage();
...
class UScriptStruct* FMetaMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MetaMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMetaMessage, Z_Construct_UPackage__Script_TCPWrapper(), TEXT("MetaMessage"));
	}
	return Z_Registration_Info_UScriptStruct_MetaMessage.OuterSingleton;
}
template<> TCPWRAPPER_API UScriptStruct* StaticStruct<FMetaMessage>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMetaMessage_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/MetaClientManager.h" },
	};
#endif
...
class UScriptStruct* FLiDARPosition::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LiDARPosition.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLiDARPosition, Z_Construct_UPackage__Script_TCPWrapper(), TEXT("LiDARPosition"));
	}
	return Z_Registration_Info_UScriptStruct_LiDARPosition.OuterSingleton;
}
template<> TCPWRAPPER_API UScriptStruct* StaticStruct<FLiDARPosition>()
{
...
class UScriptStruct* FLiDARFrameData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LiDARFrameData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLiDARFrameData, Z_Construct_UPackage__Script_TCPWrapper(), TEXT("LiDARFrameData"));
	}
	return Z_Registration_Info_UScriptStruct_LiDARFrameData.OuterSingleton;
}
template<> TCPWRAPPER_API UScriptStruct* StaticStruct<FLiDARFrameData>()
{
...
class UScriptStruct* FLiDARMapperMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LiDARMapperMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLiDARMapperMessage, Z_Construct_UPackage__Script_TCPWrapper(), TEXT("LiDARMapperMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LiDARMapperMessage.OuterSingleton;
}
template<> TCPWRAPPER_API UScriptStruct* StaticStruct<FLiDARMapperMessage>()
{
...
class UScriptStruct* FMetaBinaryMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MetaBinaryMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMetaBinaryMessage, Z_Construct_UPackage__Script_TCPWrapper(), TEXT("MetaBinaryMessage"));
	}
	return Z_Registration_Info_UScriptStruct_MetaBinaryMessage.OuterSingleton;
}
template<> TCPWRAPPER_API UScriptStruct* StaticStruct<FMetaBinaryMessage>()
{
	...
	struct Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics
	{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::NewProp_Message_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::NewProp_Message = { "Message", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_TCPWrapper_eventOnMetaMessage_Parms, Message), Z_Construct_UScriptStruct_FMetaMessage, METADATA_PARAMS(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::NewProp_Message_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::NewProp_Message_MetaData)) }; // 1853938634
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::NewProp_Message,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::Function_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_TCPWrapper, nullptr, "OnMetaMessage__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::_Script_TCPWrapper_eventOnMetaMessage_Parms), Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_TCPWrapper_OnMetaMessage__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics
	{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::NewProp_Message_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::NewProp_Message = { "Message", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_TCPWrapper_eventOnFLiDARMapperMessage_Parms, Message), Z_Construct_UScriptStruct_FLiDARMapperMessage, METADATA_PARAMS(Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::NewProp_Message_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::NewProp_Message_MetaData)) }; // 814024925
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::NewProp_Message,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MetaClientManager.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_TCPWrapper, nullptr, "OnFLiDARMapperMessage__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::_Script_TCPWrapper_eventOnFLiDARMapperMessage_Parms), Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics
	{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::NewProp_Message_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::NewProp_Message = { "Message", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_TCPWrapper_eventOnMetaBinaryMessage_Parms, Message), Z_Construct_UScriptStruct_FMetaBinaryMessage, METADATA_PARAMS(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::NewProp_Message_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::NewProp_Message_MetaData)) }; // 940104580
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::NewProp_Message,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MetaClientManager.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_TCPWrapper, nullptr, "OnMetaBinaryMessage__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::_Script_TCPWrapper_eventOnMetaBinaryMessage_Parms), Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TCPClient_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_TCPClient;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMetaClientManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMetaClientManager_Ping, "Ping" }, // 622974677
		{ &Z_Construct_UFunction_UMetaClientManager_ReceiveProto, "ReceiveProto" }, // 3913452711
		{ &Z_Construct_UFunction_UMetaClientManager_ResetBuffer, "ResetBuffer" }, // 2100078392
		{ &Z_Construct_UFunction_UMetaClientManager_SendMetaBinaryMessage, "SendMetaBinaryMessage" }, // 4223058215
		{ &Z_Construct_UFunction_UMetaClientManager_SendMetaMessage, "SendMetaMessage" }, // 900189553
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMetaClientManager_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "MetaClientManager.h" },
		{ "ModuleRelativePath", "Public/MetaClientManager.h" },
	};
#endif
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMetaClientManager_Statics::NewProp_OnMetaBinaryMessage = { "OnMetaBinaryMessage", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMetaClientManager, OnMetaBinaryMessage), Z_Construct_UDelegateFunction_TCPWrapper_OnMetaBinaryMessage__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UMetaClientManager_Statics::NewProp_OnMetaBinaryMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMetaClientManager_Statics::NewProp_OnMetaBinaryMessage_MetaData)) }; // 1951202652
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMetaClientManager_Statics::NewProp_OnLiDARMapperMessage = { "OnLiDARMapperMessage", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMetaClientManager, OnLiDARMapperMessage), Z_Construct_UDelegateFunction_TCPWrapper_OnFLiDARMapperMessage__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UMetaClientManager_Statics::NewProp_OnLiDARMapperMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMetaClientManager_Statics::NewProp_OnLiDARMapperMessage_MetaData)) }; // 2012987075
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMetaClientManager_Statics::NewProp_TCPClient_MetaData[] = {
		{ "Category", "Server" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/MetaClientManager.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMetaClientManager_Statics::NewProp_TCPClient = { "TCPClient", nullptr, (EPropertyFlags)0x001000000008000d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMetaClientManager, TCPClient), Z_Construct_UClass_UTCPClientComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMetaClientManager_Statics::NewProp_TCPClient_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMetaClientManager_Statics::NewProp_TCPClient_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMetaClientManager_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMetaClientManager_Statics::NewProp_TCPClient,
	};
	...
	template<> TCPWRAPPER_API UClass* StaticClass<UMetaClientManager>()
	{
		return UMetaClientManager::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMetaClientManager);
	UMetaClientManager::~UMetaClientManager() {}
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_PMLibrary_Source_TCPWrapper_Public_MetaClientManager_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_PMLibrary_Source_TCPWrapper_Public_MetaClientManager_h_Statics::ScriptStructInfo[] = {
		{ FMetaMessage::StaticStruct, Z_Construct_UScriptStruct_FMetaMessage_Statics::NewStructOps, TEXT("MetaMessage"), &Z_Registration_Info_UScriptStruct_MetaMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMetaMessage), 1853938634U) },
		{ FLiDARPosition::StaticStruct, Z_Construct_UScriptStruct_FLiDARPosition_Statics::NewStructOps, TEXT("LiDARPosition"), &Z_Registration_Info_UScriptStruct_LiDARPosition, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLiDARPosition), 3265918959U) },
		{ FLiDARFrameData::StaticStruct, Z_Construct_UScriptStruct_FLiDARFrameData_Statics::NewStructOps, TEXT("LiDARFrameData"), &Z_Registration_Info_UScriptStruct_LiDARFrameData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLiDARFrameData), 3123150202U) },
		{ FLiDARMapperMessage::StaticStruct, Z_Construct_UScriptStruct_FLiDARMapperMessage_Statics::NewStructOps, TEXT("LiDARMapperMessage"), &Z_Registration_Info_UScriptStruct_LiDARMapperMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLiDARMapperMessage), 814024925U) },
		{ FMetaBinaryMessage::StaticStruct, Z_Construct_UScriptStruct_FMetaBinaryMessage_Statics::NewStructOps, TEXT("MetaBinaryMessage"), &Z_Registration_Info_UScriptStruct_MetaBinaryMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMetaBinaryMessage), 940104580U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_PMLibrary_Source_TCPWrapper_Public_MetaClientManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMetaClientManager, UMetaClientManager::StaticClass, TEXT("UMetaClientManager"), &Z_Registration_Info_UClass_UMetaClientManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMetaClientManager), 2423848546U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_PMLibrary_Source_TCPWrapper_Public_MetaClientManager_h_2147424697(TEXT("/Script/TCPWrapper"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_PMLibrary_Source_TCPWrapper_Public_MetaClientManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_PMLibrary_Source_TCPWrapper_Public_MetaClientManager_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_PMLibrary_Source_TCPWrapper_Public_MetaClientManager_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_PMLibrary_Source_TCPWrapper_Public_MetaClientManager_h_Statics::ScriptStructInfo),
		nullptr, 0);
